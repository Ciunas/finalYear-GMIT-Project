...
public class ConnectionHandler implements Runnable {
     ...
     */
    public void serviceClientRequest() throws IOException  {
        boolean result;
        ...
        if (m == null) {
        	...
        	System.out.println("error in reading http request address blank" + m);
        }
        ...
        if(m.getMethod().equalsIgnoreCase("connect")) {
            ...
            if(Integer.valueOf(m.getRequestPort()) != 443) {
            	System.out.println("looking for other port than 443");
        	...
        	System.out.println("not SSL or CONNECT");
     ...
     */
    public void serviceServerResponse() throws IOException {
...
//            Log.e(ProxyMain.TAG, "EXCEPTION Connection failure: " + cfe.getMessage());
    ...
    public void writeMessage(OutputStream o, InputStream i, Message m) throws IOException {
    		...
    		System.out.println("writng date");
