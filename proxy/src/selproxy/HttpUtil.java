...
public class HttpUtil {
    ...
    public static RequestMessage parseRequest(InputStream inputStream) {
        ...
        try {
            ...
            if (reqLine == null) {
            	System.out.println("Unexpectedly reached end of stream while extracting request line");
            ...
            if(req.length != 3) {
            	...
            	System.out.println("Error parsing HTTP Request line, expected 3 have " + req.length);
